...
import 'package:todolist/Page/Edit.dart';
import 'package:todolist/Page/NOtePage.dart';
import 'package:todolist/Widget/NoteBloc.dart';
...
class _NotesPageState extends State<NotesPage> {
  ...
  Widget build(BuildContext context){
    return Scaffold(
      ...
      body: Center(
        child: isLoading ? CircularProgressIndicator() : notes.isEmpty ? Text('No Notes', style: TextStyle(color: Colors.white, fontSize: 24),): buildNotes(),
      ),
